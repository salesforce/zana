      ...
      <div className="wrap">
        ...
        <div className="nav-links desktop">
          ...
          <a
            ...
            aria-label={starsLabel ? `Star on GitHub, ${starsLabel} stars` : 'Star on GitHub'}
            title={starsLabel ? `${starsLabel} stars on GitHub` : 'Star on GitHub'}
          >
            ...
            Star
            {starsLabel ? <span className="nav-star-count">{starsLabel}</span> : null}
          </a>
