...
export function Nav({ starCount = null }: { starCount?: number | null }) {
  ...
  const starsLabel = starCount != null ? formatStarCount(starCount) : null;
      ...
      <div className="wrap">
        <Link href="/" className="brand">
          ...
          <span className="brand-full">
            Zana<span className="brand-descriptor">Command Center</span>
          </span>
        ...
        <div className="nav-links desktop">
          ...
          <a
            ...
            aria-label={
              starsLabel
                ? `Star on GitHub, ${starsLabel} stars`
                : 'Star on GitHub'
            }
            title={
              starsLabel ? `${starsLabel} stars on GitHub` : 'Star on GitHub'
            }
          >
            ...
            GitHub
            {starsLabel ? (
              <span className="nav-star-count">{starsLabel}</span>
            ) : null}
          </a>
          <div className="nav-cta">
            ...
            <Link
              href="/download/"
              className="zcc-btn zcc-btn-primary zcc-btn-sm"
            >
              Download
            </Link>
          </div>
      ...
      {open && (
        <div className="mobile-menu" id="mobile-menu">
          ...
          <a href={site.repo} target="_blank" rel="noopener noreferrer">
            {starsLabel ? `Star on GitHub · ${starsLabel}` : 'Star on GitHub'}
          </a>
        ...
        <div className="foot-top">
          <div>
            ...
            <p className="foot-blurb">
              Your agents, projects, and decisions. One clear view of the work.
            </p>
          </div>
