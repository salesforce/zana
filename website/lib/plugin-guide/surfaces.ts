...
export const SURFACE_GROUPS: SurfaceGroup[] = [
  {
    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: ['`placement: "project"` gets that `projectId`.', '`placement: "workspace"` is the Projects header (no project selected; `projectId: null`).'],
  ...
  },
  {
    ...
    title: 'Project shell',
    fixtureKind: 'spatial',
    blurb: 'Project rail, project topbar, Agents board, and statusbar.',
    surfaces: [
      {
        id: 'projectTab',
        title: 'Project tab',
        summary: 'A tab on the project rail, beside Agents and Explorer.',
        bullets: [
