...
import { GROUP_BY_SURFACE_ID, SURFACE_GROUPS, SURFACES_BY_ID, type SurfaceGroup } from './surfaces';
...
export { annotationNeighbors, panCarets, spatialFixtureScale, SURFACE_NUMBERS } from './annotation';
export { MAX_FIXTURE_SCALE } from './annotation';
