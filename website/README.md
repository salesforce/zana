...
| `/marketplace` | Live fetch of `NEXT_PUBLIC_REGISTRY_URL` — the **same `index.json`** the app reads (`src/main/extension-registry.ts`). Types mirror `packages/extension-sdk`. Falls back to bundled examples. |
