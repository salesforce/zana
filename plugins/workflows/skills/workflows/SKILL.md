---
name: workflows
description: "Author or run durable ZCC workflows when the user requests workflow execution or multi-agent orchestration."
---
...
A workflow puts deterministic control flow around normal ZCC worker threads. The
...
zcc workflows run --file .zcc/workflows/review-change.js --args '{"items":[]}'
```
...
Use zcc workflows status for compact progress. Redirect bounded history pages
...
- The source passes zcc workflows validate.
