...
describe("dispatch target rail control", () => {
  it("links a discovered Zana project", async () => {
    ...
    fireEvent.click(await slot.findByLabelText("Linked Zana project"));
  ...
  it("shows the linked Zana project's name and unlinks it", async () => {
    const updateCalls: Array<Record<string, unknown>> = [];
