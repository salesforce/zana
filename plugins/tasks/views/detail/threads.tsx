...
import { UrlLink, useBbNavigate, useRpc } from "../../compat/app";
...
import {
  ...
  DropdownMenuLabel,
  DropdownMenuTrigger,
} from "../../vendor/shared-ui/components/ui/dropdown-menu";
  ...
  return (
    <section>
      ...
      <ConfirmDialog
        ...
        description={
          confirm
            ? `"${confirm.title}" will no longer be listed on this task. The thread itself is not deleted; re-attach it with zcc tasks attach.`
            : ""
        }
        confirmLabel="Detach"
        onConfirm={() => {
