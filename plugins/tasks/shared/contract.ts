...
const projectSchema = z
  .object({
    ...
    linkedBbProjectId: z.string().regex(/^(?:proj_[A-Za-z0-9_-]+|[0-9a-f]{8}-(?:[0-9a-f]{4}-){3}[0-9a-f]{12})$/i).nullable(),
    createdAt: z.string(),
  })
  .strict();
...
const updateProjectInputSchema = z
  .object({
    ...
    linkedBbProjectId: z.string().regex(/^(?:proj_[A-Za-z0-9_-]+|[0-9a-f]{8}-(?:[0-9a-f]{4}-){3}[0-9a-f]{12})$/i).nullable().optional(),
  })
  .strict()
  .refine(
    (input) =>
  ...
  createProject: {
    input: z
      .object({
        ...
        linkedBbProjectId: z
          .string()
          .regex(/^(?:proj_[A-Za-z0-9_-]+|[0-9a-f]{8}-(?:[0-9a-f]{4}-){3}[0-9a-f]{12})$/i)
          .nullable()
          .default(null),
      })
      .strict(),
  ...
  listTaskPullRequests: {
    ...
    output: z
      .object({
        ...
        unavailableThreadIds: z.array(z.string().min(1)),
      })
      .strict(),
  },
  createPreset: {
