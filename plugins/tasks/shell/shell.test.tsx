import { TasksAppShell } from './app-shell';
import { TasksNavigationPanel } from './navigation-panel';
...
describe("tasks app shell", () => {
  it("registers the task workbench with its navigation component", () => {
    expect(tasksRegistration.path).toBe('tasks');
    expect(TasksNavigationPanel).toBeTypeOf('function');
  });
