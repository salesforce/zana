...
import { threadScope, turnScope, type ThreadEvent } from "@zana-ai/zcc-domain/thread-runtime";
import type { ProviderRuntimeEvent } from "@zana-ai/zcc-provider-bridge-protocol/bridge-kit";
import { createDeltaAssembler } from "@zana-ai/zcc-provider-bridge-protocol/assembler";
import type { DeltaAssembler } from "@zana-ai/zcc-provider-bridge-protocol/assembler";
import {
...
describe("acp delta translation (dialects)", () => {
  ...
  it("opens an OpenCode think-kind task call as a delegation", () => {
    expect(
      dialectHarness("opencode").translate(
        updateEvent({
          sessionUpdate: "tool_call",
          toolCallId: "call-task",
