...
| `salesforce/` | Official (`autoInstall: false`) — Salesforce DX inner loop. Install with `zcc plugin install salesforce`. Org doctor, SOQL/Apex/LWC/Agentforce family tools, and fail-closed mutation confirms. |
