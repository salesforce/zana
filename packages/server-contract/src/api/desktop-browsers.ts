...
export type ExperimentalDesktopBrowserInstances = {
  instances: (import("@zana-ai/zcc-host-daemon-contract").DesktopBrowserInstance & {
    hostId: string;
  })[];
};
export type ExperimentalDesktopBrowserTabs =
  import("@zana-ai/zcc-host-daemon-contract").DesktopBrowserResult<"desktop.browser.list_tabs">;
export type ExperimentalDesktopBrowserCreated =
  import("@zana-ai/zcc-host-daemon-contract").DesktopBrowserResult<"desktop.browser.create_tab">;
export type ExperimentalDesktopBrowserCapture =
  import("@zana-ai/zcc-host-daemon-contract").DesktopBrowserResult<"desktop.browser.capture_tab">;
