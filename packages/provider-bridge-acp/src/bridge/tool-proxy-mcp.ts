import { dynamicToolSchema } from "@zana-ai/zcc-domain/thread-runtime";
import type { DynamicTool } from "@zana-ai/zcc-domain/thread-runtime";
import { buildBridgeToolCallContent as experimental_buildBridgeToolCallContent } from "@zana-ai/zcc-provider-bridge-protocol/bridge-kit";
