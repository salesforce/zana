 ...
 * (`LEGACY_TOOL_ITEM_BACKFILL_MIGRATION` in @zana-ai/zcc-domain/thread-runtime), the follow-up that
 ...
 * (`threadEventItemPresentationSchema` in @zana-ai/zcc-domain/thread-runtime) — one vocabulary, no
 * translation.
 *
...
export const deltaItemShapeSchema = z.discriminatedUnion("type", [
   ...
   * data: `@zana-ai/zcc-domain/thread-runtime`'s `upgradeLegacyToolItem` reshapes read/grep/glob/
