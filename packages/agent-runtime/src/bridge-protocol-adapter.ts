 ...
 * (@zana-ai/zcc-provider-bridge-protocol) needs no bespoke adapter: commands map to
...
import { decodeNormalizedProviderToolCallRequest } from "@zana-ai/zcc-provider-bridge-protocol/bridge-kit";
