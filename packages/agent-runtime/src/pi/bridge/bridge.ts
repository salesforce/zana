...
import type { BridgeToolCallRequest } from "@zana-ai/zcc-provider-bridge-protocol/bridge-kit";
import {
  SessionManager,
...
async function handleRequest(
  ...
  switch (request.method) {
    case "initialize":
      // The canonical handshake (@zana-ai/zcc-provider-bridge-protocol): the bridge
