 ...
 * the declaration facts it is built from (capabilities and provider-owned
 * launch statics). Bundled sources are keyed by id so they do not collide
 * with artifact digests.
 */
