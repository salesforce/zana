...
function TicketsBoard({ host, project }) {
  ...
  if (isEmpty) {
    return /* @__PURE__ */ jsxs("section", { className: "gus-panel zana-panel", children: [
      subTabBar,
      activeSubTab === "profiles" ? /* @__PURE__ */ jsx(ProfilesView, { profiles, tickets, onOpen: openProfile }) : /* @__PURE__ */ jsx("div", { className: "empty-workspace overlay", children: /* @__PURE__ */ jsxs("div", { className: "empty-inner", children: [
