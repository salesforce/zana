...
import type { LaunchTeamResult } from '@shared/types';
...
vi.mock('../SquadEditor', () => ({ SquadEditor: () => null }));

import { cancelStateForResult, runTeamLaunch, runTeamLaunchExclusive, TeamLaunchStatus, menuIndexForKey, menuTabIndex } from '../SquadsPanel.js';
