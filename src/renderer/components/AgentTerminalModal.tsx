...
import { inboxQuestions } from '@shared/types';
import type { AgentState, InboxEntry, TerminalSession } from '@shared/types';
...
import { useData, usePersonas, useAgentStatus, useCatchUpSummary, useAgentPanel, useSubagents, useOverseerActivity, useIdleTriage, useInbox, useInboxAnswered } from '../store';
import { idleSurfacesToNeedsYou } from './AgentBoard';
import { inboxPrimaryTitle } from '../util/inboxPresentation';
import { QuestionBlock } from './InboxQuestionBlock';
import { AGENT_MODAL_TERMINAL_ANCHOR_ID } from './TerminalSurface';
...
import { TaskShelvesPopover } from './TaskShelvesPopover';
import { buildShelves } from '../util/taskShelves';
