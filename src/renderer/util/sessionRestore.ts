import type { LaunchProfileId, TerminalSession, Project, SessionWorktree } from '../../shared/types.js';
import { isClaudeProfile, isCodexProfile, isOpenCodeProfile } from '../../shared/launch-provider.js';
