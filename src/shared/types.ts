...
import type { WorkflowArgument } from './workflow-args';
import type { UsageSummary } from './telemetry-events';
import type { ApplyAuthorizationInput, AuthorizationApplyResult } from './authorizations';

export type { WorkflowArgument } from './workflow-args';
export type { ApplyAuthorizationInput, AuthorizationApplyResult } from './authorizations';
...
export interface AppConfig {
   ...
   * See `src/shared/terminalThemes.ts`.
   */
   ...
   * `src/renderer/util/terminalWheel.ts`.
   */
   ...
   * one (see src/main/updater.ts). Absent ⇒ nothing skipped.
   */
...
export interface QuickPrompt {
   ...
   * `{{name}}` placeholders (see `src/shared/workflow-args.ts`); applying the
