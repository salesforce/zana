 ...
 *
 * A sibling of {@link ../inbox-store.ts}, NOT a feed category: it holds RUNNABLE
...
import type { Suggestion, SuggestionInput, SuggestedActionKind } from '../shared/types.js';

export type { Suggestion, SuggestionInput } from '../shared/types.js';
