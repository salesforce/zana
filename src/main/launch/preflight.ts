...
import type { HarnessExecutionTarget, HarnessProfilePosture, HarnessScope } from '../../shared/harness-adapter.js';
import type { ExecutionEvidenceFixture } from '../harness/execution-evidence.js';
import { evaluateExecutionEvidence } from '../harness/execution-evidence.js';
import type {
  ExecutionConsentBinding,
  ExecutionConsentReserveResult,
  ExecutionConsentScope
} from '../harness/execution-consent-store.js';
import type { ExecutionConsentCeremonyInput } from '../harness/execution-consent.js';
