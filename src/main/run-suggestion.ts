...
import type { CreateTerminalRequest, LaunchProfileId, Result, TerminalSession } from '../shared/types.js';
import type { SuggestedActionKind } from '../shared/types.js';
import type { ISuggestionsStore } from './suggestions-store.js';
import { parseProfile } from '../shared/launch-provider.js';
