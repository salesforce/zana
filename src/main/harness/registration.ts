...
import type { AppConfig, CreateTerminalRequest, HarnessFamily, LaunchProfileId, TerminalSession } from '../../shared/types.js';
import type { HarnessAgentDiscoveryResult } from '../../shared/harness-adapter.js';
...
export interface HarnessRegistration extends SdkHarnessRegistration<LaunchProfileId, LaunchProvider> {
  ...
  readonly renderLifecycle?: (input: {
    ...
    readonly caps: import('../../shared/launch-provider.js').ProviderCapabilities;
