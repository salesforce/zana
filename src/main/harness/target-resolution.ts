import type { AppConfig, Persona, ProjectSettings, LaunchProfileId, HarnessModelRoutingV1 } from '../../shared/types.js';
...
export interface ExecutionResolution {
  ...
  source: 'Agent' | 'Persona' | 'Project' | 'Global' | 'native-default';
  targetId?: string;
  equivalence?: import('../../shared/harness-adapter.js').HarnessExecutionEquivalence;
