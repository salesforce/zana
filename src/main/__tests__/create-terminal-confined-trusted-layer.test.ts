...
import type { Project, AppConfig, ProjectSettings, Persona } from '../../shared/types.js';
...
const { createTerminalConfined, frameworkPersonaFromEntries } = await import('../index.js');
