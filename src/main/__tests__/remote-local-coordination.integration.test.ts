 ...
 * `src/main/index.ts` with NO transport mocks:
 *
...
import { createAgentRegistryStore } from '../agent-registry-store.js';
import { createAgentMessageLog } from '../agent-message-log.js';
