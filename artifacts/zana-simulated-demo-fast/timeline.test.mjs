...
import './timeline.js';
const {storyStateAt:stateAt,storyCursorAt:cursorAt,typed,prompt,pluginPrompt}=globalThis.DemoTimeline;
const DURATION=190;
const chapters=globalThis.DemoTimeline.chapters.map(c=>stateAt(globalThis.DemoTimeline.toStory(c.at)).chapter);
const moves=globalThis.DemoTimeline.moves.map(m=>[globalThis.DemoTimeline.toStory(m[0]),...m.slice(1)]);
