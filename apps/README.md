...
| `server` | Product policy, durable state, extension grants, and event hub | Serves the packaged renderer and issues authenticated, HMAC-signed execution commands; current Electron main remains the compatibility authority during extraction. |
