...
import type { ProjectExecutionConsentGrant } from '@zana-ai/zcc-domain/product';
import { ProjectExecutionConsentList, shouldShowExecutionConsent } from '@/views/settings/ProjectSettingsView';
