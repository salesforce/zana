 ...
 *
 * Style mirrors `packages/domain/src/launch-provider.guard.test.ts`: strip
...
const TOOL_AGNOSTIC_FILES = [
  'apps/server/src/services/skills/skills.ts',
  'apps/app/src/views/extensions/SkillsView.tsx',
  'apps/app/src/views/extensions/ProjectSkillsView.tsx'
];
