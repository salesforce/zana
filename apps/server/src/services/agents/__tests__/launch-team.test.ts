...
const { authorizeTeamLaunch, launchTeam, cascadeCloseTeamOnOrchestratorExit } = await import('../../../../../desktop/src/host.js');
...
describe('cascadeCloseTeamOnOrchestratorExit', () => {
  type S = import('@zana-ai/zcc-domain/product').TerminalSession;
  const mk = (
    id: string,
