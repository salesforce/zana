...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@zana-ai/zcc-domain/git-checkout': resolve(__dirname, '../../packages/domain/src/git-checkout.ts'),
      ...
      '@zana-ai/zcc-plugin-sdk/provider-bridge/acp': resolve(
        __dirname,
        '../../packages/plugin-sdk/src/provider-bridge-acp.ts'
      ),
      '@zana-ai/zcc-plugin-sdk/provider-bridge': resolve(
        __dirname,
        '../../packages/plugin-sdk/src/provider-bridge.ts'
      ),
      '@zana-ai/zcc-plugin-sdk/ai-services': resolve(
        __dirname,
        '../../packages/plugin-sdk/src/ai-services.ts'
      ),
      '@zana-ai/zcc-plugin-sdk/host': resolve(__dirname, '../../packages/plugin-sdk/src/host.ts'),
