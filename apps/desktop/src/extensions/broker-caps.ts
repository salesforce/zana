...
import type { McpPool } from '@zana-ai/zcc-host-daemon/zana/mcp-pool';
import type { StreamRelay } from './stream-relay.js';
import type { HostCommandRelay } from './host-command-relay.js';
import type { LlmService } from '@zana-ai/zcc-llm';
import type { LlmPromptEntry } from '@zana-ai/zcc-domain/product';
 ...
 *
 * `llmEnabled` is the global {@link import('@zana-ai/zcc-domain/product').AppConfig}
