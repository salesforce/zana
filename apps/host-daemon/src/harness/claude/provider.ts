...
import { extractPinnedSessionId, buildSystemPromptGuidance, inboxAllowedTools } from '@zana-ai/zcc-spawn-plan';
...
export class ClaudeCodeProvider extends BaseLaunchProvider {
  ...
  launchMetadata(_input: {
    ...
    observedAt: number;
  }): import('@zana-ai/zcc-domain/product').SessionMetadataSnapshot {
